...
import type { SummarySectionContent } from '../../shared/types/api.js'
...
export type CampgroundSummarySections = SummarySectionContent

export interface GenerateCampgroundSummaryOptions {
  campgroundId?: string
