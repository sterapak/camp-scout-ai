...
/**
 * Computes variance percentage between local and external values.
 * @param {number} local
 * @param {number} external
 * @returns {number | undefined}
 */
function computeVariancePercent(local, external) {
  if (external === 0) {
 ...
 */
export function generateReconciliationReport(openAiBilling = {}) {
