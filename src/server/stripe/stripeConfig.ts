...
export const STRIPE_PRICE_ID_5_ENV = 'STRIPE_PRICE_ID_5'
export const STRIPE_PRICE_ID_10_ENV = 'STRIPE_PRICE_ID_10'
export const STRIPE_PRICE_ID_25_ENV = 'STRIPE_PRICE_ID_25'
export const CAMP_SCOUT_PUBLIC_URL_ENV = 'CAMP_SCOUT_PUBLIC_URL'
...
const PRICE_ID_ENV_BY_AMOUNT: Record<DonationAmount, string> = {
  5: STRIPE_PRICE_ID_5_ENV,
  10: STRIPE_PRICE_ID_10_ENV,
  25: STRIPE_PRICE_ID_25_ENV,
}
...
export function resolveCheckoutBaseUrl(requestOrigin?: string): string | undefined {
  const configured = process.env[CAMP_SCOUT_PUBLIC_URL_ENV]?.trim()
  if (configured) {
